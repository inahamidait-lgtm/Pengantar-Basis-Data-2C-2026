...
(25003, 'Kiarа Sabrina', 2025, 'Teknik Informatika'),
...
SELECT
  MIN(mk.sks) AS SKS_Minimal,
  MAX(mk.sks) AS SKS_Maksimal,
  AVG(mk.sks) AS Rata_Rata_SKS,
